...
export default function GamePage({ gameId, onExit }) {
  ...
  // Calcul dynamique du nombre de joueurs actuels pour éviter les bugs si la clé n'existe pas
  const currentPlayersCount = game.players ? Object.keys(game.players).length : 0;
  const maxPlayersAllowed = game.maxPlayers || 10; // Par défaut 10 joueurs max si non défini
    ...
    <div className="game-container">
      ...
      <div className="game-content">
        ...
        <div className="players-section">
          ...
          {/* Formulaire désormais accessible même si la partie est vide au départ */}
          {currentPlayersCount < maxPlayersAllowed && (
            <div className="add-player-form" style={{ marginTop: '1.5rem', display: 'flex', gap: '10px' }}>
              <input 
                type="text" 
